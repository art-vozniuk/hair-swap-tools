...
from hair_swap_api.diffusers.configuration_utils import ConfigMixin, register_to_config
from hair_swap_api.diffusers.loaders import UNet2DConditionLoadersMixin
from hair_swap_api.diffusers.utils import BaseOutput, logging
from hair_swap_api.diffusers.models.activations import get_activation
from hair_swap_api.diffusers.models.attention_processor import (
...
from hair_swap_api.diffusers.models.lora import LoRALinearLayer
from hair_swap_api.diffusers.models.embeddings import (
...
from hair_swap_api.diffusers.models.modeling_utils import ModelMixin
from hair_swap_api.diffusers.models.unet_2d_blocks import (
...
class ref_unet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if num_attention_heads is not None:
            raise ValueError(
                "At the moment it is not possible to define the number of attention heads via `num_attention_heads` because of a naming issue as described in https://github.com/huggingface/hair_swap_api.diffusers/issues/2011#issuecomment-1547958131. Passing `num_attention_heads` will only be supported in hair_swap_api.diffusers v0.19."
            )

        # If `num_attention_heads` is not defined (which is the case for most models)
        # it will default to `attention_head_dim`. This looks weird upon first reading it and it is.
        # The reason for this behavior is to correct for incorrectly named variables that were introduced
        # when this library was created. The incorrect naming was only discovered much later in https://github.com/huggingface/hair_swap_api.diffusers/issues/2011#issuecomment-1547958131
